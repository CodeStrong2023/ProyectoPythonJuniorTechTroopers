...
class InsertInfo:
    ...
    def insertar_usuario(self, datos_usuario):
        """
                ...
                Raises:
                    Error: Si ocurre un error durante la inserción de datos.
                """
        sql = """
        INSERT INTO Usuarios (username, password, nombre, apellido, documento, fecha_nacimiento, edad, telefono, saldo, activo)
